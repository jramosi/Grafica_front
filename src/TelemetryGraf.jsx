...
const BACKEND_URL = 'https://api.render.com/deploy/srv-d3mopdk9c44c73b79dgg?key=iTWFRRbtEmk'; // Asegúrate de que coincida con tu Node.js
...
const TelemetryGraphs = () => {
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Temperatura en Tiempo Real (THB-01)',
            },
        },
    };
